...
public class RegistrationPhoneUserCreation implements FormActionFactory, FormAction {
  ...
  public void validate(ValidationContext context) {
    ...
    if (Validation.isBlank(phoneNumber)) {
      errors.add(new FormMessage(SupportPhonePages.FIELD_PHONE_NUMBER, SupportPhonePages.Errors.MISSING.message()));
      ...
      try {
        ...
        if (!Utils.isDuplicatePhoneAllowed(session) &&
          ...
          context.error(Errors.INVALID_REGISTRATION);
          errors.add(new FormMessage(SupportPhonePages.FIELD_PHONE_NUMBER, SupportPhonePages.Errors.EXISTS.message()));
          context.validationError(formData, errors);
          success = false;
        }
  ...
  public void success(FormContext context) {
    ...
    context.getEvent().detail(Details.USERNAME, username)
        ...
        .detail(SupportPhonePages.FIELD_PHONE_NUMBER,phoneNumber);
