...
import org.tecklens.splkeycloak.providers.keycloak.phone.authentication.requiredactions.UpdatePhoneNumberRequiredAction;
...
import org.tecklens.splkeycloak.providers.keycloak.phone.providers.jpa.TokenCode;
...
public class DefaultPhoneVerificationCodeProvider implements PhoneVerificationCodeProvider {
    ...
    public void tokenValidated(UserModel user, String phoneNumber, String tokenCodeId, boolean isOTP) {
        ...
        logger.info("updateUserPhoneNumber:" + updateUserPhoneNumber);
        if (isOTP) {
            logger.info("isOTP:" + isOTP);
    ...
    public void validateProcess(String tokenCodeId, UserModel user) {
        ...
        logger.info("validateProcess:" + entity.toString() + user.toString());
    ...
    private void updateUserOTPCredential(UserModel user, String phoneNumber, String code) {
        ...
        logger.info("updateUserOTPCredential");
