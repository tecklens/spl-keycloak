...
public class AuthenticationCodeAuthenticator extends BaseDirectGrantAuthenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        Optional<String> phoneNumber = getPhoneNumber(context);
        logger.info(phoneNumber.get());
        phoneNumber.ifPresentOrElse(number -> validateVerificationCode(context,number),
